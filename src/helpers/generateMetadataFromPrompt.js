...
export async function generateMetadataFromPrompt(slot, musicPrompt) {
  const system = `
You are a music marketing assistant for a city pop YouTube channel. 
...
Requirements:
- The title should be unique, evocative, and include keywords like "City Pop", "Lo-Fi", or "Vaporwave" when appropriate.
- The description should be 2–3 sentences long and include keywords that improve discoverability (e.g., Japanese city pop, retro synth, aesthetic vibes, chill beats).
- Tags should be lowercase, relevant, and YouTube-friendly (e.g., ["city pop", "lofi", "retro tokyo"]).
